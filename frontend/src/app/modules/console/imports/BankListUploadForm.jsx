...
export default function BankListUploadForm() {
    ...
    const onSubmit = React.useCallback(
        form => {
            ...
            apiClient
                .doPost('/banks/imports', { headers, body: formData })
                .then(() => {
                    notification.notify('Bank List File is Uploaded', { type: 'success' });
                    form.setSubmitting(false);
                })
                .catch(() => {
                    notification.notify('Bank List File could not be Uploaded', {
                        type: 'warning'
                    });
                    form.setSubmitting(false);
                });
        ...
        <Formix.Form fieldsInitializer={defineFields} onSubmit={onSubmit} initialValue={null}>
            {({ fields, handleSubmit, isValid, isSubmitting }) => (
                <form noValidate onSubmit={handleSubmit}>
                    <Layout.Card
                        header="Datei mit Bankliste zum hochladen auswählen"
                        footer={
