...
import solutions.ethio.speedcontrol.application.repository.AuthorityRepository;
...
public class AccountResourceIntTest extends AbstractIntegrationTest
{
    ...
    public void testGetExistingAccount() throws Exception
    {
        ...
        user.setEmail("john.doe@speed-control.com");
        ...
        restUserMockMvc.perform(get("/api/account")
                ...
                .andExpect(jsonPath("$.email").value("john.doe@speed-control.com"))
